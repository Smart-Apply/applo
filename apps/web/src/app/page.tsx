...
export default function Home() {
  ...
  // Companion driver: pose per section, plus a mascot that peeks out from behind
  // the hero receipt card (with an intro pop-up) then rides along as a corner buddy.
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      // CTA celebration + hide the corner buddy over pricing / CTA.
      let inCta = false;
      if (ctaSec) {
