...
- **JobPosting**, **Application** (incl. `translations` Json — per-language translation cache for cross-language exports, invalidated by content xxhash), **ResumeTemplate**, **Interview**
