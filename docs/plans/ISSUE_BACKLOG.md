...
| 10 | [#523](https://github.com/Smart-Apply/applo/issues/523) | Anonymized usage dataset export for ML/due-diligence | **P3** | M | ✅ delivered, re-scoped |
...
### 10 · #523 — usage dataset export — **delivered (re-scoped)**
