...
> **Status:** ✅ Complete (2026-07-22) — all workstreams shipped: §3.1 catalog fix, §3.2+§3.3 per-application design settings, §3.4 font bundling, §3.6 design panel, §3.5 photo support, §3.7 layout breadth (✅ 2026-07-22: three new TSX designs — **Modern Two-Column** (light sidebar-left, hairline divider, category "Modern"), **Minimal Single-Column** (generous whitespace, hairline section rules, category "Minimal"), **Executive Serif** (Times/Merriweather, double rule, centered small-caps headers, category "Executive") — each with 3 color variants, full designs-settings/font/photo/sectionOrder support, registry + seed entries, spec coverage in the shared design-settings/font-bundling/section-order suites, and validate-script targets. Catalog now offers 6 designs × 3 colors. Note: heavy letterSpacing was reduced to ≤0.8px after pdf-parse extraction (= ATS proxy) split tracked headings into single letters — caught by the specs). · **Priority:** P2 (competitor-parity; contained one real P1 bug in §2.5 — **✅ fixed 2026-07-22**, see §3.1)
