...
| `MISTRAL_API_KEY`               | Fly Secrets ← Mistral La Plateforme console | API (extraction fast lane — `LLM_FAST_PROVIDER=mistral`; missing/invalid key degrades to the main provider, never breaks generation) |
